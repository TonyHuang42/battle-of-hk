            ...
            <div class="row g-4">
                <div class="col-12 col-sm-6 col-lg">
                    <article class="benefit-card h-100">
                        <img src="https://placehold.co/500x350?text=Benefit+Image" alt="香港保衛戰" class="w-100 benefit-card-image mb-3">
                ...
                <div class="col-12 col-sm-6 col-lg">
                    <article class="benefit-card h-100">
                        <img src="https://placehold.co/500x350?text=Benefit+Image" alt="游擊與抵抗" class="w-100 benefit-card-image mb-3">
                ...
                <div class="col-12 col-sm-6 col-lg">
                    <article class="benefit-card h-100">
                        <img src="https://placehold.co/500x350?text=Benefit+Image" alt="日治下的香港" class="w-100 benefit-card-image mb-3">
                ...
                <div class="col-12 col-sm-6 col-lg">
                    <article class="benefit-card h-100">
                        <img src="https://placehold.co/500x350?text=Benefit+Image" alt="人物與故事" class="w-100 benefit-card-image mb-3">
